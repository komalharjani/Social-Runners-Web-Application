...
app.post('/addUser/:id', async (req, res) => {
	...
	console.log(body);
	const user = modelUser.User.fromJSON(body);
	console.log(user);
...
var dbRun = new dao.DAORun(configRun.db_info.url, configRun.db_info.username, configRun.db_info.password);
