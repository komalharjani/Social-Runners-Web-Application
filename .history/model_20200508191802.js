(function () {
    ...
    class Run {
        ...
        toJSON() {
         ...
         get distance() { return this._origin; }
         set name(newOrigin) {
             if (typeof (newOrigin) === 'string' && newOrigin != "") this._origin = newOrigin;
             else throw new Error("Invalid Origin");
         }
 
         get pace() { return this._destination; }
         set destination(newDestination) {
             if (typeof (newDestination) === 'string' && newDestination != "") this._destination = newDestination;
             else throw new Error("Invalid Destination");
         }

         get duration() { return this._destination; }
         set destination(newDestination) {
             if (typeof (newDestination) === 'string' && newDestination != "") this._destination = newDestination;
             else throw new Error("Invalid Destination");
         }

         get date() { return this._destination; }
         set destination(newDestination) {
             if (typeof (newDestination) === 'string' && newDestination != "") this._destination = newDestination;
             else throw new Error("Invalid Destination");
         }

         get startTime() { return this._destination; }
         set destination(newDestination) {
             if (typeof (newDestination) === 'string' && newDestination != "") this._destination = newDestination;
             else throw new Error("Invalid Destination");
         }
