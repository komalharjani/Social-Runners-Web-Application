(function () {
    ...
    class Run {
        //ID is automatic
        constructor(title, origin, destination, distance, pace, duration, date, startTime, description, meetingPointOne, meetingPointTwo, maxPeople, comments) {
            this.title = title;
            this.origin = origin;
        ...
        toJSON() {
         ...
         set title(newTitle) {
             if (typeof (newTitle) === 'string' && newTitle != "") this._title = newTitle;
             else throw new Error("Missing Title");
         }
        ...
        //origin and destination input
         ...
         //Date must not be empty - validation on client side
