(function () {
    ...
    class Run {
        ...
        //build User from json
        static fromJSON(json) {
            return new Run(json.origin, json.destination, json.distance, json.pace, json.duration, json.date, json.startTime, json.description, json.meetingPointOne, json.meetingPointTwo, json.maxPeople, json.comments, json.email);
        }
    }
