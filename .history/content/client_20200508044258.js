...
function generateSquares() {
	...
	if (arrayLength > 0) {
		for (let i = 0; i < arrayLength; i++) {
			...
			table.append(readMore);
			readMore.innerText = "Delete"; //hide from view or delete from db - not ethical

			var divContainerMap = document.getElementById("right");
			divContainerMap.appendChild(map);
