...
async function getRunPosts() {
	...
	let byDateRun = document.getElementById("datePost");
	let byDatePost = document.getElementById("dateRun");
	let byPace = document.getElementById("byPace");

	byDateRun.onclick() = function() {
		
	}

	byDatePost.onclick() = function() {

	}

	byPace.onclick() = function() {
