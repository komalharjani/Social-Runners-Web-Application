(function () {
    ...
    class Run {
        constructor() {
            let comments = []; //array of objects containing comments in model comments format
            let details = []; //single object representing the data for that run
            let maxParticipants; //number of participants allowed to join a game
        }
    }
